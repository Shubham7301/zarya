...
class ApiService {
  ...
  static Map<String, dynamic> _getDemoDashboardStats() {
    return {
      ...
      'topServices': [
        {'name': 'Haircut & Styling', 'count': 8, 'revenue': 360.0},
        {'name': 'Hair Coloring', 'count': 5, 'revenue': 425.0},
        {'name': 'Manicure', 'count': 6, 'revenue': 150.0},
        {'name': 'Facial Treatment', 'count': 4, 'revenue': 260.0},
        {'name': 'Makeup Application', 'count': 2, 'revenue': 110.0},
      ],
    };
  }
